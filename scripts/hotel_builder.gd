...
func create_materials() -> void:
	...
	_apply_texture(mat_carpet, "res://textures/carpet.png", 0.5)
	
	mat_corridor_carpet = _mat(Color(0.12, 0.08, 0.06), 0.92)
	_apply_texture(mat_corridor_carpet, "res://textures/carpet.png", 0.8)
	
	mat_wall = _mat(Color(0.38, 0.35, 0.28), 0.85)
	_apply_texture(mat_wall, "res://textures/wallpaper.png", 0.25)
	
	mat_wall_accent = _mat(Color(0.28, 0.22, 0.16), 0.85)
	_apply_texture(mat_wall_accent, "res://textures/wallpaper.png", 0.25)
	
	mat_ceiling = _mat(Color(0.1, 0.1, 0.11), 0.9)
	_apply_texture(mat_ceiling, "res://textures/ceiling.png", 0.4)
	
	mat_wood = _mat(Color(0.22, 0.14, 0.08), 0.75)
	_apply_texture(mat_wood, "res://textures/wood.png", 0.5)
	
	mat_wood_dark = _mat(Color(0.12, 0.07, 0.04), 0.8)
	_apply_texture(mat_wood_dark, "res://textures/wood.png", 0.5)
	...
	_apply_texture(mat_door, "res://textures/wood.png", 0.5)
	
	mat_tile = _mat(Color(0.75, 0.73, 0.7), 0.5)
	_apply_texture(mat_tile, "res://textures/tile.png", 0.5)
